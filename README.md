...
```> python binu8_tool.py dump <script_folder_path> <output_csv_path>```
> Extract the strings from Script folder binu8 files into a csv file

```> python binu8_tool.py import <script_folder_path> <input_csv_path> <output_script_folder_path>```
>Create a new binu8 files based on the original Script folder binu8 files and the modified csv file
